<%@ Page Title="فرم ورود کاربر" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="Login" %>
        ...
        <div align="center" class="container jumbotron bg-light boxshadow" style="width:49%; height: 411px;">
            <form>
                ...
                <div>
                    ...
                    <asp:LinkButton ID="LinkButton2" runat="server" CssClass="btn btn-link" PostBackUrl="~/Registration.aspx">New User!</asp:LinkButton>
                    <asp:LinkButton ID="LinkButton3" runat="server" CssClass="btn btn-link" PostBackUrl="~/ChangingPassword.aspx">ChangingPassword</asp:LinkButton>
                </div>
            </form>
        </div>
</asp:Content>
